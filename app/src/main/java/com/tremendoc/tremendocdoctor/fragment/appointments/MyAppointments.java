...
import com.tremendoc.tremendocdoctor.adapter.AppointmentAdapter;
import com.tremendoc.tremendocdoctor.viewmodel.AppointmentViewModel;
...
public class MyAppointments  extends Fragment {
    ...
    public static MyAppointments newInstance(boolean b) {
        MyAppointments frag = new MyAppointments();
        frag.refresh = b;
        return frag;
    }
