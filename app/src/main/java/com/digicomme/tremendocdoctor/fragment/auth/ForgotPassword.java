package com.digicomme.tremendocdoctor.fragment.auth;
        ...
        call.post(URLS.INITIATE_PASSWORD_RESET, params, response -> {
            ...
            try {
                ...
                if (resObj.has("code") &&  resObj.getInt("code") == 0) {
                    ToastUtil.showLong(ctx, "Password reset initiated");
                    fragmentChanger.changeFragment(ResetPassword.newInstance());
